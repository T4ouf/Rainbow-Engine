...
namespace Rainbow {
	...
	Material::Material(ShaderName shader, Texture* texture, glm::vec3 ambient, glm::vec3 diffuse, glm::vec3 specular, float shininess) :
		m_texture(texture), m_ambient(ambient), m_diffuse(diffuse), m_specular(specular), m_shininess(shininess) {
